...
- Co-author "Sardar Ahmad Ali (232147)" is taken from
  `docs/COAL_Final_Report.docx` — kept per the decision to preserve
  standard academic group-project attribution.
